...
this.emailValidation = (browser) => {
  ...
  invalidEmails.forEach((value) => {
    browser.setValue("form#contactForm div:nth-child(4) div:nth-child(2) div input.input", value);
    ...
    browser.getTitle((title) => {
      if(title === 'HW Template Sandbox') {
        ...
        browser.clearValue("form#contactForm div:nth-child(4) div:nth-child(2) div input.input");
      }
    });
  });
