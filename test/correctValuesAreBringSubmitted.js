this.correctValuesAreBeingSubmitted = (browser) => {
  ...
  browser.url((result) => {
    browser.assert.equal(result.value, "http://hw.test.hwuat.com/?firstname=George&lastname=Bryant&job=QA+Analyst&phone=07432659576&email1=testEmail%40testDomain.com&email2=testEmail%40testDomain.com&radio-options=Yes");
  });
