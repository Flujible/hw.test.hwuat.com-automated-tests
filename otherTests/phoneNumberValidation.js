...
this.phoneNumberValidation = (browser) => {
  ...
  invalidNumbers.forEach((value) => {
    browser
      .setValue("form#contactForm div:nth-child(3) div:nth-child(2) div input.input", value)
      .click("button.btn")
      .verify.containsText("form#contactForm div:nth-child(3) div:nth-child(2) div p.errorMessage", "Please enter a valid phone number")
